...
export async function GET(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const res = await query(`
      SELECT id, key, name, description, max_generations_per_day, max_generations_per_month, max_free_generations, stripe_product_id, stripe_price_monthly_id, stripe_price_annual_id, show_watermark, allow_private_images, allow_camera, allow_upload, allow_reimagine,
