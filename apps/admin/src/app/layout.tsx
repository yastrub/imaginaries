...
import { DashboardOutlined, PictureOutlined, AppstoreOutlined, TagsOutlined, GiftOutlined, CreditCardOutlined, FileTextOutlined, LogoutOutlined, UsergroupAddOutlined } from "@ant-design/icons";
...
const FallbackRedirect: React.FC = () => {
  ...
  return (
    <div style={{padding:24}}>
      Please sign in to access admin. You can sign in on the main app, then refresh, or use the <a href="/login">admin login</a>.
    </div>
  );
};
